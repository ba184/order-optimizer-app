...
const mockWorkflows: ApprovalWorkflow[] = [
  {
    ...
    type: 'distributor',
    steps: [
      { level: 1, role: 'ASM', autoEscalate: 24 },
      { level: 2, role: 'RSM', autoEscalate: 24 },
      { level: 3, role: 'Credit Team', autoEscalate: 48 },
      { level: 4, role: 'Accounts', autoEscalate: 48 },
    ],
    isActive: true,
  ...
  },
  {
    ...
    type: 'order',
    steps: [
      { level: 1, role: 'ASM', condition: 'Order > ₹2L', autoEscalate: 4 },
      { level: 2, role: 'RSM', condition: 'Order > ₹5L', autoEscalate: 8 },
    ],
    isActive: true,
    createdAt: '2024-01-15',
  },
  ...
  },
  {
    ...
    type: 'leave',
    steps: [
      { level: 1, role: 'ASM', autoEscalate: 12 },
