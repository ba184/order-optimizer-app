  ...
  public: {
    Tables: {
      ...
      collateral_issues: {
        ...
        Relationships: [
          {
            foreignKeyName: "collateral_issues_collateral_id_fkey"
            columns: ["collateral_id"]
            isOneToOne: false
            referencedRelation: "marketing_collaterals"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "collateral_issues_instructed_by_fkey"
            columns: ["instructed_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "collateral_issues_issued_by_fkey"
            columns: ["issued_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      marketing_collaterals: {
        ...
        Relationships: [
          {
            foreignKeyName: "marketing_collaterals_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
